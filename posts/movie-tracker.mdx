...
tags:
  ...
  - project
date: 2022-01-28
excerpt: A web-application to track your movies.
external: false
url: ""
project: true
---
...
- I would have liked the UI to be responsive, but there isn't a feature to make the tables responsive in MUI. I refrained from going with another library, since working with MUI was my main goa I refrained from going with another library, since working with MUI and Supabase authentication was my main goal.
- One of the limitation of this project is that testing was not included.
- The project also had a relatively narrow focus on movie tracking, limiting its utility for any broader use cases.